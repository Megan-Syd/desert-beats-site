...
export const classesData : ClassesData[] = [
    {
        ...
        timePlace: "Classes are on Mondays (January 19 - April 13) from 6:45-7:45pm in the big studio.",
    ...
    },
    {
        ...
        timePlace: "Classes are on Mondays (January 19 - April 13) from 7:45-9:00pm in the big studio.",
    ...
    },
    {
        ...
        timePlace: "Classes are on Thursdays (January 22 - April 16) from 7:45-9:00pm in the green studio.",
    ...
    },
    {
        ...
        timePlace: "Classes are on Thursdays from (January 22 - April 16) 7:00-7:45pm in the green studio. ",
