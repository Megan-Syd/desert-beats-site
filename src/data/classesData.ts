...
export const classesData : ClassesData[] = [
    {
        ...
        timePlace: "Classes are on Mondays (September 15 - December 8) from 6:45-7:45pm in the big studio.",
    ...
    },
    {
        ...
        timePlace: "Classes are on Mondays (September 15 - December 8) from 7:45-9:00pm in the big studio.",
    ...
    },
    {
        ...
        timePlace: "Classes are on Thursdays (September 18 - December 4) from 7:45-9:00pm in the green studio.",
    ...
    },
    {
        ...
        timePlace: "Classes are on Thursdays from (September 18 - December 4) 7:00-7:45pm in the green studio. ",
